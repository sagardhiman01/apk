...
CREATE TABLE IF NOT EXISTS projects (
  ...
  inst_photo_1 VARCHAR(500),
  inst_photo_2 VARCHAR(500),
...
ALTER TABLE projects ADD COLUMN IF NOT EXISTS inst_photo_1 VARCHAR(500) DEFAULT NULL;
ALTER TABLE projects ADD COLUMN IF NOT EXISTS inst_photo_2 VARCHAR(500) DEFAULT NULL;
